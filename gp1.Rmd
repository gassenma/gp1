...
final_pred_2 <- ifelse((as.numeric(lr_final_2$lr_results) + as.numeric(knn_final_2)) > 0, 1, 0)
final_pred_2 <- as.data.frame(final_pred_2)

final_pred_4 <- ifelse((as.numeric(lr_final_4$lr_results) + as.numeric(knn_final_4)) > 0, 1, 0)
final_pred_4 <- as.data.frame(final_pred_4)

final_pred_5 <- ifelse((as.numeric(lr_final_5$lr_results) + as.numeric(knn_final_5)) > 0, 1, 0)
